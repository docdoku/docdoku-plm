 ...
 */
public class CheckOutCommand implements Action {

    private ExplorerPage m_mainPage;

    public CheckOutCommand(ExplorerPage mainPage) {
        m_mainPage = mainPage;
    }
    ...
    public void execute(Object... userObject) {
        for (MasterDocumentDTO mdoc : m_mainPage.getSelectedMDocs()) {
            ...
            ServiceLocator.getInstance().getExplorerService().checkOut(workspaceId, id, version, callback);
        }
    }
}
