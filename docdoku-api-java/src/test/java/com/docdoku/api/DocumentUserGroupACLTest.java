...
public class DocumentUserGroupACLTest {
    ...
    public static void initTestData() throws ApiException {
        ...
        user1Client = new DocdokuPLMBasicClient(TestConfig.URL, account1.getLogin(), TestConfig.PASSWORD).getClient();
        user2Client = new DocdokuPLMBasicClient(TestConfig.URL, account2.getLogin(), TestConfig.PASSWORD).getClient();
    ...
    public void testFullAccessGroupACL() throws ApiException {
        ...
        // Workspace admin always allowed
        TestUtils.assertUserCanRetrieveDocument(TestConfig.REGULAR_USER_CLIENT, document, true);
        ...
        // Workspace admin always allowed
        TestUtils.assertUserCanEditDocument(TestConfig.REGULAR_USER_CLIENT, document, true);
