...
public class ExplorerFrame extends JFrame implements HasElementSelectedListeners{
    ...
    public ExplorerFrame(TransferHandler pTransferHandler) {
        this(null,pTransferHandler);
    }
    
    private ExplorerFrame(Component pLocationRelative, TransferHandler pTransferHandler) {
    ...
    public void duplicate() {
        ExplorerFrame explorerFrame = new ExplorerFrame(this,mTransferHandler);
