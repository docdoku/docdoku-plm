...
casper.test.begin('Public shared document tests suite', 2, function publicSharedDocumentTestsSuite() {
    ...
    casper.then(function checkDocumentTitle() {
        return this.waitForSelector('#content > .document-revision > div >  h3', function titleDisplayed() {
    ...
    casper.then(function checkIterationNote() {
        ...
        return this.waitForSelector('#content > .document-revision > div >  h3', function iterationNoteDisplayed() {
