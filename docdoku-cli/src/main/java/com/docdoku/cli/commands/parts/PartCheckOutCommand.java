...
public class PartCheckOutCommand extends BaseCommandLine {
    ...
    public void execImpl() throws Exception {
        ...
        checkoutPart(partNumber, revision, alreadyProcessed);
    }
    ...
    private void checkoutPart(String pPartNumber, String pRevision, Set<String> alreadyProcessed) throws IOException, ApiException, LoginException, NoSuchAlgorithmException {
        ...
        if (recursive) {
            for (PartUsageLinkDTO link : pi.getComponents()) {
                ...
                checkoutPart(linkNumber, null, alreadyProcessed);
            }
        }
