...
@DeclareRoles("users")
@Local(IRoleManagerLocal.class)
@Stateless(name = "RoleManagerBean")
@WebService(endpointInterface = "com.docdoku.core.services.IRoleManagerWS")
public class RoleManagerBean implements IRoleManagerWS, IRoleManagerLocal {
    ...
    private final static Logger LOGGER = Logger.getLogger(RoleManagerBean.class.getName());
