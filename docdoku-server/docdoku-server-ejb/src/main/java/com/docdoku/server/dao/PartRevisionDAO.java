...
public class PartRevisionDAO {
    ...
    public List<PartRevision> searchPartRevisions(String pWorkspaceId, String pNumber, String pName, String pVersion, String pAuthor, String pType, Date pCreationDateFrom, Date pCreationDateTo, List<PartSearchQuery.AbstractAttributeQuery> pAttrs) {
