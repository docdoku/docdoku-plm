...
public class PathFilteredInstanceMessageBodyWriter implements MessageBodyWriter<PathFilteredListInstanceCollection> {
    @Override
    public boolean isWriteable(Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType) {
        return type.equals(PathFilteredListInstanceCollection.class);
    }

    @Override
    public long getSize(PathFilteredListInstanceCollection t, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType) {
        return -1;
    }

    @Override
    public void writeTo(PathFilteredListInstanceCollection object, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType, MultivaluedMap<String, Object> httpHeaders, OutputStream entityStream) throws UnsupportedEncodingException {
