...
(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.SwaggerClient = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
    ...
    "use strict";var SwaggerHttp=require("./http"),_={isObject:require("lodash-compat/lang/isObject"),cloneDeep:require("lodash-compat/lang/cloneDeep"),isArray:require("lodash-compat/lang/isArray")},Resolver=module.exports=function(){this.failedUrls=[]};Resolver.prototype.processAllOf=function(e,i,o,r,t,s){var n,l,f;o["x-resolved-from"]=["#/definitions/"+i];var a=o.allOf;for(a.sort(function(e,i){return e.$ref&&i.$ref?0:e.$ref?-1:1}),n=0;n<a.length;n++)f=a[n],l="/definitions/"+i+"/allOf",this.resolveInline(e,s,f,r,t,l)},Resolver.prototype.resolve=function(e,i,o,r){this.spec=e;var t,s,n=i,l=o,f=r,a={};"function"==typeof i&&(n=null,l=i,f=o);var p=n;this.scope=f||this,this.iteration=this.iteration||0,this.scope.options&&this.scope.options.requestInterceptor&&(a.requestInterceptor=this.scope.options.requestInterceptor),this.scope.options&&this.scope.options.responseInterceptor&&(a.responseInterceptor=this.scope.options.responseInterceptor);var h,v,d,c,u=0,y={},g={},O=[];e.definitions=e.definitions||{};for(h in e.definitions){var m=e.definitions[h];for(c in m.properties)d=m.properties[c],_.isArray(d.allOf)?this.processAllOf(n,h,d,O,g,e):this.resolveTo(n,d,O,"/definitions");m.allOf&&this.processAllOf(n,h,m,O,g,e)}for(h in e.paths){var x,b,k;v=e.paths[h];for(x in v)if("$ref"===x)t="/paths"+h,this.resolveInline(n,e,v,O,g,t);else{b=v[x];var A=v.parameters||[],j=b.parameters||[];for(s in A){var R=A[s];j.unshift(R)}"parameters"!==x&&_.isObject(b)&&(b.parameters=b.parameters||j);for(s in j){var R=j[s];if(t="/paths"+h+"/"+x+"/parameters","body"===R["in"]&&R.schema)if(_.isArray(R.schema.allOf)){for(var $="inline_model",h=$,q=!1,w=0;!q;){if("undefined"==typeof e.definitions[h]){q=!0;break}h=$+"_"+w,w++}e.definitions[h]={allOf:R.schema.allOf},delete R.schema.allOf,R.schema.$ref="#/definitions/"+h,this.processAllOf(n,h,e.definitions[h],O,g,e)}else this.resolveTo(n,R.schema,O,t);R.$ref&&this.resolveInline(n,e,R,O,g,R.$ref)}for(k in b.responses){var I=b.responses[k];if(t="/paths"+h+"/"+x+"/responses/"+k,_.isObject(I)&&(I.$ref&&this.resolveInline(n,e,I,O,g,t),I.schema)){var T=I;if(_.isArray(T.schema.allOf)){for(var $="inline_model",h=$,q=!1,w=0;!q;){if("undefined"==typeof e.definitions[h]){q=!0;break}h=$+"_"+w,w++}e.definitions[h]={allOf:T.schema.allOf},delete T.schema.allOf,delete T.schema.type,T.schema.$ref="#/definitions/"+h,this.processAllOf(n,h,e.definitions[h],O,g,e)}else this.resolveTo(n,I.schema,O,t)}}}v.parameters=[]}var D,U=0,S=[],H=O;for(s=0;s<H.length;s++){var N=H[s];if(n===N.root){if("ref"===N.resolveAs){var P,z=((N.root||"")+"/"+N.key).split("/"),E=[],J="";if(N.key.indexOf("../")>=0){for(var Q=0;Q<z.length;Q++)".."===z[Q]?E=E.slice(0,E.length-1):E.push(z[Q]);for(P=0;P<E.length;P++)P>0&&(J+="/"),J+=E[P];N.root=J,S.push(N)}else if(D=N.key.split("#"),2===D.length){(0===D[0].indexOf("http://")||0===D[0].indexOf("https://"))&&(N.root=D[0]),t=D[1].split("/");var B,C=e;for(P=0;P<t.length;P++){var F=t[P];if(""!==F){if(C=C[F],"undefined"==typeof C){B=null;break}B=C}}null===B&&S.push(N)}}else if("inline"===N.resolveAs){if(N.key&&-1===N.key.indexOf("#")&&"/"!==N.key.charAt(0)){for(D=N.root.split("/"),t="",s=0;s<D.length-1;s++)t+=D[s]+"/";t+=N.key,N.root=t,N.location=""}S.push(N)}}else S.push(N)}U=S.length;for(var G=0;G<S.length;G++)!function(e,i,o){if(e.root&&e.root!==n)if(-1===o.failedUrls.indexOf(e.root)){var r={useJQuery:!1,url:e.root,method:"get",headers:{accept:o.scope.swaggerRequestHeaders||"application/json"},on:{error:function(t){u+=1,console.log("failed url: "+r.url),o.failedUrls.push(r.url),g[e.key]={root:e.root,location:e.location},u===U&&o.finish(i,p,O,y,g,l)},response:function(r){var t=r.obj;o.resolveItem(t,e.root,O,y,g,e),u+=1,u===U&&o.finish(i,p,O,y,g,l)}}};f&&f.clientAuthorizations&&f.clientAuthorizations.apply(r),(new SwaggerHttp).execute(r,a)}else u+=1,g[e.key]={root:e.root,location:e.location},u===U&&o.finish(i,p,O,y,g,l);else o.resolveItem(i,p,O,y,g,e),u+=1,u===U&&o.finish(i,n,O,y,g,l,!0)}(S[G],e,this);0===Object.keys(S).length&&this.finish(e,p,O,y,g,l)},Resolver.prototype.resolveItem=function(e,i,o,r,t,s){var n=s.location,l=e,f=n.split("/");if(""!==n)for(var a=0;a<f.length;a++){var p=f[a];if(-1!==p.indexOf("~1")&&(p=f[a].replace(/~0/g,"~").replace(/~1/g,"/"),"/"!==p.charAt(0)&&(p="/"+p)),"undefined"==typeof l||null===l)break;if(""===p&&a===f.length-1&&f.length>1){l=null;break}p.length>0&&(l=l[p])}var h=s.key;f=s.key.split("/");var v=f[f.length-1];v.indexOf("#")>=0&&(v=v.split("#")[1]),null!==l&&"undefined"!=typeof l?r[h]={name:v,obj:l,key:s.key,root:s.root}:t[h]={root:s.root,location:s.location}},Resolver.prototype.finish=function(e,i,o,r,t,s,n){var l;for(l in o){var f=o[l],a=f.key,p=r[a];if(p)if(e.definitions=e.definitions||{},"ref"===f.resolveAs){if(n!==!0)for(a in p.obj)var h=this.retainRoot(p.obj[a],f.root);e.definitions[p.name]=p.obj,f.obj.$ref="#/definitions/"+p.name}else if("inline"===f.resolveAs){var v=f.obj;v["x-resolved-from"]=[f.key],delete v.$ref;for(a in p.obj){var h=p.obj[a];n!==!0&&(h=this.retainRoot(p.obj[a],f.root)),v[a]=h}}}var d=this.countUnresolvedRefs(e);0===d||this.iteration>5?(this.resolveAllOf(e.definitions),s.call(this.scope,e,t)):(this.iteration+=1,this.resolve(e,i,s,this.scope))},Resolver.prototype.countUnresolvedRefs=function(e){var i,o=this.getRefs(e),r=[],t=[];for(i in o)0===i.indexOf("#")?r.push(i.substring(1)):t.push(i);for(i=0;i<r.length;i++)for(var s=r[i],n=s.split("/"),l=e,f=0;f<n.length;f++){var a=n[f];if(""!==a&&(l=l[a],"undefined"==typeof l)){t.push(s);break}}return t.length},Resolver.prototype.getRefs=function(e,i){i=i||e;var o={};for(var r in i)if(i.hasOwnProperty(r)){var t=i[r];if("$ref"===r&&"string"==typeof t)o[t]=null;else if(_.isObject(t)){var s=this.getRefs(t);for(var n in s)o[n]=null}}return o},Resolver.prototype.retainRoot=function(e,i){for(var o in e){var r=e[o];if("$ref"===o&&"string"==typeof r){if(0!==r.indexOf("http://")&&0!==r.indexOf("https://")){var t=!0;if(i){var s=i.slice(-1);if("/"!==s&&0!==r.indexOf("#")&&0!==r.indexOf("http://")&&r.indexOf("https://")){console.log("working with "+r),t=!1;var n=i.split("/");n=n.splice(0,n.length-1),i="";for(var l=0;l<n.length;l++)i+=n[l]+"/"}}0!==r.indexOf("#")&&t&&(r="#"+r),r=(i||"")+r,e[o]=r}}else _.isObject(r)&&this.retainRoot(r,i)}return e},Resolver.prototype.resolveInline=function(e,i,o,r,t,s){var n,l,f,a,p=o.$ref,h=o.$ref,v=!1;if(e=e||"",h){if(0===h.indexOf("../")){for(l=h.split("../"),f=e.split("/"),h="",n=0;n<l.length;n++)""===l[n]?f=f.slice(0,f.length-1):h+=l[n];for(e="",n=0;n<f.length-1;n++)n>0&&(e+="/"),e+=f[n];v=!0}if(h.indexOf("#")>=0)if(0===h.indexOf("/"))a=h.split("#"),l=e.split("//"),f=l[1].split("/"),e=l[0]+"//"+f[0]+a[0],s=a[1];else{if(a=h.split("#"),""!==a[0]){if(f=e.split("/"),f=f.slice(0,f.length-1),!v){e="";for(var d=0;d<f.length;d++)d>0&&(e+="/"),e+=f[d]}e+="/"+h.split("#")[0]}s=a[1]}0===h.indexOf("http")?(h.indexOf("#")>=0?(e=h.split("#")[0],s=h.split("#")[1]):(e=h,s=""),r.push({obj:o,resolveAs:"inline",root:e,key:p,location:s})):0===h.indexOf("#")?(s=h.split("#")[1],r.push({obj:o,resolveAs:"inline",root:e,key:p,location:s})):r.push({obj:o,resolveAs:"inline",root:e,key:p,location:s})}else"array"===o.type&&this.resolveTo(e,o.items,r,s)},Resolver.prototype.resolveTo=function(e,i,o,r){var t,s,n=i.$ref,l=e;if("undefined"!=typeof n&&null!==n){if(n.indexOf("#")>=0){var f=n.split("#");if(f[0]&&0===n.indexOf("/"));else if(f[0]&&0===f[0].indexOf("http"))l=f[0],n=f[1];else if(f[0]&&f[0].length>0){for(t=e.split("/"),l="",s=0;s<t.length-1;s++)l+=t[s]+"/";l+=f[0]}r=f[1]}else if(0===n.indexOf("http://")||0===n.indexOf("https://"))l=n,r="";else{for(t=e.split("/"),l="",s=0;s<t.length-1;s++)l+=t[s]+"/";l+=n,r=""}o.push({obj:i,resolveAs:"ref",root:l,key:n,location:r})}else if("array"===i.type){var a=i.items;this.resolveTo(e,a,o,r)}else if(i&&i.properties){var p=this.uniqueName("inline_model");i.title&&(p=this.uniqueName(i.title)),delete i.title,this.spec.definitions[p]=_.cloneDeep(i),i.$ref="#/definitions/"+p,delete i.type,delete i.properties}},Resolver.prototype.uniqueName=function(e){for(var i=e,o=0;;){if(!_.isObject(this.spec.definitions[i]))return i;i=e+"_"+o,o++}},Resolver.prototype.resolveAllOf=function(e,i,o){o=o||0,i=i||e;var r;for(var t in i)if(i.hasOwnProperty(t)){var s=i[t];if(null===s)throw new TypeError("Swagger 2.0 does not support null types ("+i+").  See https://github.com/swagger-api/swagger-spec/issues/229.");if("object"==typeof s&&this.resolveAllOf(e,s,o+1),s&&"undefined"!=typeof s.allOf){var n=s.allOf;if(_.isArray(n)){var l=_.cloneDeep(s);delete l.allOf,l["x-composed"]=!0,"undefined"!=typeof s["x-resolved-from"]&&(l["x-resolved-from"]=s["x-resolved-from"]);for(var f=0;f<n.length;f++){var a=n[f],p="self";"undefined"!=typeof a["x-resolved-from"]&&(p=a["x-resolved-from"][0]);for(var h in a)if(l.hasOwnProperty(h))if("properties"===h){var v=a[h];for(r in v){l.properties[r]=_.cloneDeep(v[r]);var d=v[r]["x-resolved-from"];("undefined"==typeof d||"self"===d)&&(d=p),l.properties[r]["x-resolved-from"]=d}}else if("required"===h){for(var c=l.required.concat(a[h]),u=0;u<c.length;++u)for(var y=u+1;y<c.length;++y)c[u]===c[y]&&c.splice(y--,1);l.required=c}else"x-resolved-from"===h&&l["x-resolved-from"].push(p);else if(l[h]=_.cloneDeep(a[h]),"properties"===h)for(r in l[h])l[h][r]["x-resolved-from"]=p}i[t]=l}}}};
