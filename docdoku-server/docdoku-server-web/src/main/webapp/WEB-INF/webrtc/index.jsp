    ...
    <body>
        <script type="text/javascript">
            ...
            function createPeerConnection() {
                ...
                try {
                    pc = new webkitRTCPeerConnection("${pcConfig}", onIceCandidate);
            ...
            function onChannelClosed(message) {                
            ...
            function onUserMediaError(error) {
                console.log("onUserMediaError. Error code was " + error.code);
            ...
            function onRemoteStreamAdded(event) {
                ...
                miniVideo.src = decodeURIComponent(localVideo.src);                
                remoteVideo.src = decodeURIComponent(url);
                waitForRemoteVideo();  
            }
        ...
        <div id="container" ondblclick="enterFullScreen()"> 
            <div id="card">
                <div id="local">
                    <video width="200" height="200" id="localVideo" autoplay="autoplay"/>
                </div>
                <div id="remote">
                    <video width="500" height="500" id="remoteVideo" autoplay="autoplay">
                    </video>
                    <div id="mini">
