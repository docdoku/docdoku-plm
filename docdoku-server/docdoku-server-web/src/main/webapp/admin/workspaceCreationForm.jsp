...
<html xmlns="http://www.w3.org/1999/xhtml">
    <fmt:setBundle basename="com.docdoku.server.localization.admin.workspaceCreationForm_resource"/>
    <head>
    ...
    <body>
        <div id="page">
            ...
            <div id="content">
                ...
                <form action="<%=request.getContextPath()%>/admin/createWorkspace" method="post" onsubmit="javascript: return checkForm();" name="workspace" id="workspace"><fieldset>
