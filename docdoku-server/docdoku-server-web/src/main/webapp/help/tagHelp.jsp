    ...
    <body>
        ...
        <div id="page">
            ...
            <div id="content">
                ...
                <div class="headline">
                    <fmt:message key="category6.title"/>
                </div>
                
                <h4><fmt:message key="category6.question1"/></h4>
                <blockquote><p><fmt:message key="category6.answer1"/></p></blockquote>
                <h4><fmt:message key="category6.question2"/></h4>
                <blockquote><p><fmt:message key="category6.answer2"/></p></blockquote>            
