    ...
    <body>
        ...
        <div id="page">
            ...
            <div id="content">
                ...
                <div class="headline">
                    <fmt:message key="category3.title"/>
                </div>
                
                <h4><fmt:message key="category3.question1"/></h4>
                <blockquote><p><fmt:message key="category3.answer1"/></p></blockquote>
                <h4><fmt:message key="category3.question2"/></h4>
                <blockquote><p><fmt:message key="category3.answer2"/></p></blockquote>
                <h4><fmt:message key="category3.question3"/></h4>
                <blockquote><p><fmt:message key="category3.answer3"/></p></blockquote>
                <h4><fmt:message key="category3.question4"/></h4>
                <blockquote><p><fmt:message key="category3.answer4"/></p></blockquote>
