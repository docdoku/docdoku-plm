    ...
    var ChatMessageSessionView = Backbone.View.extend({
        ...
        template: _.template(
            ...
            '<div class="chat_webrtc_invite">' +
                ...
                '<a class="btn btn btn-success accept-webrtc"> <i class="fa fa-video-camera"></i> '+i18n.VIDEO_INVITE_ACCEPT+'</a>' +
	            '<a class="btn btn-danger reject-webrtc"> <i class="fa fa-times"></i> '+i18n.VIDEO_INVITE_REJECT+'</a></div>' +
