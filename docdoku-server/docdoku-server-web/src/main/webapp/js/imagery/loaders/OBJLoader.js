...
THREE.OBJLoader.prototype.load = function ( url, callback, type, dataParams ) {
	...
	xhr.onreadystatechange = function () {
		...
		if ( xhr.readyState == 4 ) {
			...
			if ( xhr.status == 200 || xhr.status == 0 ) {
				...
				callback( that.parse( xhr.responseText, dataParams));
...
THREE.OBJLoader.prototype.parse = function ( data, dataParams ) {
