...
define([
    ...
    var LinkedRequestsView = LinkedItemsView.extend({
        ...
        initialize: function () {
            ...
            this.options.label = APP_CONFIG.i18n.ADD_REQUEST;
        },
        ...
        bindTypeahead: function () {
            ...
            this.referenceInput.typeahead({
                source: function (query, process) {
                    $.getJSON(APP_CONFIG.contextPath + '/api/workspaces/' + APP_CONFIG.workspaceId + '/changes/requests/link/?q=' + query, function (data) {
