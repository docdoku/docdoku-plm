...
define({
    ...
    DAYS_SHORT: ["dim.", "lun.", "mar.", "mer.", "jeu.", "ven.", "sam.", "dim."],
    DAYS_MIN: ["d", "l", "ma", "me", "j", "v", "s", "d"],
	...
	ITERATION_NOTE_PROMPT_LABEL: "La note de révision n'a pas été définie. Souhaitez-vous l'ajouter ?",
	ITERATION_NOTE_PROMPT_OK: "Ajouter la note de révision",
