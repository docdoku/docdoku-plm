...
define(['backbone',
    ...
    var ProductInstancePathIterationDataModel = Backbone.Model.extend({
        ...
        url: function () {
            return App.config.contextPath + '/api/workspaces/' + App.config.workspaceId + '/products/' + App.config.productId + '/product-instances/' +this.serialNumber + '/pathdata/'+this.getId()+'/'+this.getIteration();
        },
