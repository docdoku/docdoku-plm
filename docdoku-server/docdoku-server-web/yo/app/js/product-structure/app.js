/*global define,App,APP_CONFIG,dat,ChannelStatus*/
'use strict';
define(
    [
        "backbone",
        ...
        var AppView = Backbone.View.extend({
            ...
            render: function () {
                ...
                this.$el.html(Mustache.render(template, {productId: APP_CONFIG.productId, contextPath: APP_CONFIG.contextPath, i18n: APP_CONFIG.i18n})).show();
            ...
            exportScene: function () {
                ...
                iframeSrc += '/' + APP_CONFIG.configSpec;
            ...
            onNoWebGLSupport: function () {
                this.centerSceneContainer.find("#scene_container").html('<span class="no-webgl">' + APP_CONFIG.i18n.NO_WEBGL + '</span>');
