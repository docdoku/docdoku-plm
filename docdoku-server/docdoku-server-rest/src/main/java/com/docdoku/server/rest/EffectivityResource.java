...
public class EffectivityResource {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public EffectivityDTO getEffectivity(@ApiParam(required = true, value = "Effectivity id") @PathParam("effectivityId") String effectivityId) throws EffectivityNotFoundException {
    ...
    @Path("/{effectivityId}")
    @Produces(MediaType.APPLICATION_JSON)
    public Response updateEffectivity(@ApiParam(required = true, value = "Effectivity id") @PathParam("effectivityId") String effectivityId,
        ...
        Effectivity effectivity = effectivityManager.updateEffectivity(effectivityId, effectivityDTO.getName(), effectivityDTO.getName());
    ...
    @Path("/{effectivityId}")
    @Produces(MediaType.APPLICATION_JSON)
    public Response deleteEffectivity(@ApiParam(required = true, value = "Effectivity id") @PathParam("effectivityId") String effectivityId) throws EffectivityNotFoundException {
