...
casper.test.begin('Document deletion tests suite', 1, function documentDeletionTestsSuite() {
    ...
    casper.then(function waitForDocumentDisplayed() {
        this.waitForSelector('#document-management-content table.dataTable tbody tr[title="'+documents.document1.number+'"] td.reference', function documentIsDisplayed() {
    ...
    casper.then(function waitForDocumentDeletion() {
        this.waitWhileSelector('#document-management-content table.dataTable tbody tr[title="'+documents.document1.number+'"]', function documentDeleted() {
