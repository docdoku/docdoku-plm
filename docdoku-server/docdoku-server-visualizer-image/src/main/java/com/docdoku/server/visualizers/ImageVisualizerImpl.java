...
@ImageVisualizer
public class ImageVisualizerImpl implements DocumentVisualizer{
    @Override
    ...
    public String getJspPageName() throws Exception {
        return "imagePlayer.jspf";  //To change body of implemented methods use File | Settings | File Templates.
    }
