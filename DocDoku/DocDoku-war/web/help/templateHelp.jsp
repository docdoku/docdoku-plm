    ...
    <body>
        ...
        <div id="page">
            ...
            <div id="content">
                ...
                <div class="headline">
                    <fmt:message key="category5.title"/>
                </div>
                
                <h4><fmt:message key="category5.question1"/></h4>
                <blockquote><p><fmt:message key="category5.answer1"/></p></blockquote>
                <h4><fmt:message key="category5.question2"/></h4>
                <blockquote><p><fmt:message key="category5.answer2"/></p></blockquote>
                <h4><fmt:message key="category5.question3"/></h4>
                <blockquote><p><fmt:message key="category5.answer3"/></p></blockquote>            
