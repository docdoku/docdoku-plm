...
public class CreateWorkspaceServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest pRequest,
        ...
        try {
            ...
            Workspace.VaultType vaultType = Workspace.VaultType.FREE;
            ...
            Workspace workspace = commandService.createWorkspace(id, account, description, vaultType,folderLocked);
