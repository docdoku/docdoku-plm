 ...
 */
public class StateDelegate implements TableDelegate {

    private IconFactory iconFactory;


    public StateDelegate(IconFactory iconFactory){
    ...
    public void render(TableModelIndex index, int row, int column, TableWidget table, String[] tooltip) {
        ...
        if (value instanceof Boolean) {
            ...
            Image icon = null;
            if (castedValue) {
                icon = iconFactory.createStateSubscriptionIcon(true, model.getValueAt(index.getRow()).getWorkspaceId(), model.getValueAt(index.getRow()).getId(), model.getValueAt(index.getRow()).getVersion());
            } else {
                icon = iconFactory.createStateSubscriptionIcon(false, model.getValueAt(index.getRow()).getWorkspaceId(), model.getValueAt(index.getRow()).getId(), model.getValueAt(index.getRow()).getVersion());
            }
