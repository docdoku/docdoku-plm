 ...
 */
public class CreateMDocCommand implements Action {

    private ExplorerPage m_mainPage;

    public CreateMDocCommand(ExplorerPage mainPage) {
        m_mainPage = mainPage;
    }
    ...
    public void execute(Object... userObject) {
        ...
        String mdocId = (String) userObject[2];
        ...
        ServiceLocator.getInstance().getExplorerService().createMDoc(parentFolder, mdocId, title, description, templateId, workflowModelId, acl, callback);
