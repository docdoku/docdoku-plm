 ...
 */
public class IterationSubscriptionCommand implements Action {

    private ExplorerPage m_mainPage;

    public IterationSubscriptionCommand(ExplorerPage mainPage) {
        m_mainPage = mainPage;
    }
    ...
    public void execute(Object... userObject) {
            ...
            if(subscribe)
                ...
                ServiceLocator.getInstance().getExplorerService().unsubscribeToIterationChangeEvent(workspaceId, id, version, callback);
