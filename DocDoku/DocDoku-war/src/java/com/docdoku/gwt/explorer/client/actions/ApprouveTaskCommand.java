 ...
 */
public class ApprouveTaskCommand implements Action{

    private ExplorerPage m_mainPage ;

    public ApprouveTaskCommand(ExplorerPage m_mainPage) {
    ...
    public void execute(Object... userObject) {
        ...
        ServiceLocator.getInstance().getExplorerService().approve(workspaceId, workflowId, activityStep, taskStep, comment, callback);
    }
