 ...
 */
public class MDocTemplateIdDelegate implements TableDelegate{
    ...
    public void render(TableModelIndex index, int row, int column, TableWidget table, String[] tooltip) {
        ...
        String html = HTMLUtil.imageItemHTML(imageBundle.templateRowIcon(), value) ;
