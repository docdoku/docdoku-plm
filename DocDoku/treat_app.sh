...
/usr/bin/jarsigner -storepass changeit DocDoku-war/web/apps/docdoku_client.jar docdoku4
/usr/bin/jarsigner -storepass changeit DocDoku-war/web/apps/docdoku_common.jar docdoku4
