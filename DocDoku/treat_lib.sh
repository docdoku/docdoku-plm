...
/usr/bin/pack200 --repack --segment-limit=-1 DocDoku-war/web/apps/lib/scanner.jar
...
/usr/bin/jarsigner -storepass changeit DocDoku-war/web/apps/lib/commons-codec-1.3.jar docdoku4
/usr/bin/jarsigner -storepass changeit DocDoku-war/web/apps/lib/swingx.jar docdoku4
/usr/bin/jarsigner -storepass changeit DocDoku-war/web/apps/lib/synthetica.jar docdoku4
/usr/bin/jarsigner -storepass changeit DocDoku-war/web/apps/lib/syntheticaBlueMoon.jar docdoku4
/usr/bin/jarsigner -storepass changeit DocDoku-war/web/apps/lib/syntheticaAddons.jar docdoku4
/usr/bin/jarsigner -storepass changeit DocDoku-war/web/apps/lib/syntheticaBlueMoonAddon.jar docdoku4
/usr/bin/jarsigner -storepass changeit DocDoku-war/web/apps/lib/l2fprod.jar docdoku4
/usr/bin/jarsigner -storepass changeit DocDoku-war/web/apps/lib/scanner.jar docdoku4
/usr/bin/jarsigner -storepass changeit DocDoku-war/web/apps/lib/ws.jar docdoku4
/usr/bin/jarsigner -storepass changeit DocDoku-war/web/apps/lib/javaee.jar docdoku4
...
/usr/bin/pack200 --segment-limit=-1 DocDoku-war/web/apps/lib/scanner.jar.pack.gz DocDoku-war/web/apps/lib/scanner.jar
