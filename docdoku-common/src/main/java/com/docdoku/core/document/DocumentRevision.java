...
@NamedQueries ({
        ...
        @NamedQuery(name="DocumentRevision.findByTask", query="SELECT d FROM DocumentRevision d, Task t WHERE (t.activity.workflow = d.workflow OR t.activity.workflow member of d.abortedWorkflows) AND t = :task")
})
